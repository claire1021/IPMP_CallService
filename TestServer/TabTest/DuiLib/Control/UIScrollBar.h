...
namespace DuiLib
{
	...
	public:
		...
		LPCTSTR GetButton1HotImage1();
		void SetButton1HotImage1(LPCTSTR pStrImage);
		...
		LPCTSTR GetButton2HotImage1();
		void SetButton2HotImage1(LPCTSTR pStrImage);
		...
		LPCTSTR GetThumbHotImage1();
		void SetThumbHotImage1(LPCTSTR pStrImage);
		...
		LPCTSTR GetRailHotImage1();
		void SetRailHotImage1(LPCTSTR pStrImage);
		...
		LPCTSTR GetBkHotImage1();
		void SetBkHotImage1(LPCTSTR pStrImage);
	...
	protected:
		...
		TDrawInfo m_diBkHot;
		//lxm,aaded,2015年7月10日12:00:43
		//添加鼠标划过，但不在滑块内的图片
		TDrawInfo m_diBkHot1;
		...
		//lxm,aaded,2015年7月10日12:00:43
		//添加鼠标划过，但不在滑块内的图片
		TDrawInfo m_diRailHot1;

		TDrawInfo m_diRailPushed;
		TDrawInfo m_diRailDisabled; 

		//lxm,added,2015年7月10日13:22:09
		//鼠标进入则为hot1状态，除需要绘制hot状态的部分其他全部绘制hot1状态
		bool m_bHot1;
	};
}
