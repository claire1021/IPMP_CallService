...
// 	CPaintManagerUI* GetParentResource() const;
    ...
    LPCTSTR GetDefaultAttributeList(LPCTSTR pStrControlName,bool bShare = false) const;
	...
	// add by yym 2015年7月29日16:48:25 begin
	int GetPreMessagesCount();
	CPaintManagerUI *GetPreMessagesAt(UINT nIndex);
	// add by yym 2015年7月29日16:48:25 end
	//add,lxm,2015年8月28日
	 void ShowKeyBoard( bool bShow, CControlUI * pControl = NULL);
	 void SetAutoMove(bool bAuto);
	 // IsLButtonDown
private:
...
private:
    ...
    CStdPtrArray m_aPostPaintControls;// 水平垂直滚动条及其子类
	...
	//lxm,added,2015年8月28日 软键盘
	static HWND m_hKeyBoard;	
	//软键盘弹出前窗口位置
	CDuiRect m_rcWidnow;
	//是否随软键盘移动窗口
	BOOL m_bMoveWithKeyBoard;
	bool m_bShowKeyboard;
	//鼠标左键是否被按下
	//static BOOL m_bLButtonDown;
public:
