...
#define DUI_MSGTYPE_TOUCHUP					(_T("touchup"))
#define DUI_MSGTYPE_TOUCHDOWN				(_T("touchdown"))
//lxm,added,2015年10月7日，添加鼠标弹起消息
...
#define DUI_MSGTYPE_SLIDERUP				(_T("sliderup"))
...
#define DUI_CTR_SLIPPINGTABLAYOUT				(_T("SlippingTabLayout"))

#define DUI_CTR_SLIGHTTABLAYOUT					(_T("SlightTabLayout"))
#define  DUI_CTR_TRANS_EDIT                            (_T("TransEdit"))

#define	 DUI_CTR_TIMEEDIT				(_T("TimeEdit"))
///
//////////////END控件名称宏定义//////////////////////////////////////////////////
