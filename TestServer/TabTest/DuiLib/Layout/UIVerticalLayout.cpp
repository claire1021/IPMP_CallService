...
// 		if( m_pHorizontalScrollBar && m_pHorizontalScrollBar->IsVisible() ) rc.bottom -= m_pHorizontalScrollBar->GetFixedHeight();
		...
		for( int it2 = 0; it2 < m_items.GetSize(); it2++ ) {
			...
			//lxm,added,2015年8月14日
			CDuiSize s = GetScrollPos();
			if(nRight < rcCtrl.right+ s.cx) nRight = rcCtrl.right + s.cx;
		...
		//lxm,chenged,2015年8月14日
		ProcessScrollBar(rc, nRight - m_rcItem.left, cyNeeded);
